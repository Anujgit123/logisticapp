...
<div class="row">
				...
				if(isset($_GET['id']))
				{
					...
					?>
                                    ...
                                    <div class="form-group">
                                            ...
                                            <input type="text" class="form-control " readonly placeholder="Enter Payment Gateway Name" value="<?php echo $data['title'];?>" name="cname" required="">
                                        </div>
	  ...
	  <?php 
		...
		{
			$dname = mysqli_real_escape_string($lundry,$_POST['cname']);
			$attributes = mysqli_real_escape_string($lundry,$_POST['p_attr']);
			$ptitle = mysqli_real_escape_string($lundry,$_POST['ptitle']);
			$okey = $_POST['status'];
			$p_show = $_POST['p_show'];
