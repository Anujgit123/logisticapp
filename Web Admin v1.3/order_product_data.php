...
?>
  ...
  ?>
              ...
              <div class="card style-2">
                ...
                <div class="card-body">
                  <div class="row">
					...
					<?php 
					$getpoints = $lundry->query("select * from tbl_drop_points where order_id=".$pid."");
					$i=0;
                     while($rows = $getpoints->fetch_assoc())
					 {
						 $i = $i + 1;
					?>
					<div class="col-12 col-md-12" style="margin-bottom: 10px;display:flex;">
    ...
    padding: 7px;
    border-radius: 50%;
    color: white;"><?php echo $i;?></span> Drop Address:
                      </p>

                      <p class="mb-7 mb-md-0">
                       <?php echo $rows['drop_address'];?>
                      </p>
					  </div>
