...
$returnArr = array("ResponseCode"=>"200","Result"=>"true","ResponseMsg"=>"Wallet Balance Get Successfully!","code"=>$wallet['code'],"signupcredit"=>$curr['scredit'],"refercredit"=>$curr['rcredit'],"mobile"=>$set['smobile'],"email"=>$set['semail'],"pagelist"=>$c);
}
else 
{
