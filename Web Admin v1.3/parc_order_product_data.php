...
$pid = $_POST['pid'];
$c = $lundry->query("select * from tbl_parcel where id=".$pid."")->fetch_assoc();
...
<div id="divprint">
  ...
  <div class="card-body bg-white mb-2">
                ...
                <div class="row d-flex">
                  <div class="col-md-3">
                    <!-- Heading -->
                    <h6 class="text-muted mb-1 card-title">Order Nos:</h6>
                    <!-- Text -->
                    <p class="mb-lg-0 font-size-sm font-weight-bold"><?php echo $pid;?></p>
                  </div>
                  <?php 
$date=date_create($c['logistic_date']);
...
?>
    ...
    margin-left: auto!important;"><?php echo $c['total'].' '.$set['currency'];?></span>
			  ...
			  <div class="card style-2 mb-2">
                <div class="card-header">
                  <h4 class="mb-0 card-title">Payment & Category & Vehicle</h4>
                </div>
                <div class="card-body">
                  <ul class="list-group list-group-sm list-group-flush-y list-group-flush-x">
