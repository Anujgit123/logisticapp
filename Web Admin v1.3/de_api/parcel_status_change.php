...
else 
{
	...
	$checks = $lundry->query("select * from tbl_parcel where id=".$oid."")->fetch_assoc();
...
$content = array(
       "en" => $name.', Your Parcel Order #'.$oid.' Has Been Processed.'
   );
$heading = array(
   "en" => "Parcel Order Processed!!"
);
...
curl_close($ch);
	...
	$returnArr = array("ResponseCode"=>"200","Result"=>"true","ResponseMsg"=>"Parcel Order Accepted Successfully!!!!!","Next_step"=>"pickup");    
	}
}
...
$h = new Laundrore();
	...
	$content = array(
       "en" => $name.', Your Parcel Order #'.$oid.' Out For Delivery.'
   );
$heading = array(
   "en" => "Parcel Order On Route!!"
);
...
curl_close($ch); 
	...
	$returnArr = array("ResponseCode"=>"200","Result"=>"true","ResponseMsg"=>"Parcel Order Pickup Successfully!!!!!","Next_step"=>"Deliverey");    
...
$h = new Laundrore();
	...
	$returnArr = array("ResponseCode"=>"200","Result"=>"false","ResponseMsg"=>"Parcel Order Rejected Successfully!!!!!");    
}
...
$h = new Laundrore();
	 ...
	 $content = array(
       "en" => $name.', Your Parcel Order #'.$oid.' Has Been Delivered.'
   );
$heading = array(
   "en" => "Parcel Order Delivered!!"
);
...
curl_close($ch); 
	...
	$returnArr = array("ResponseCode"=>"200","Result"=>"true","ResponseMsg"=>"Parcel Order Delivered Successfully!!!!!","Next_step"=>"Done");    
}
else 
{
	$returnArr = array("ResponseCode"=>"401","Result"=>"false","ResponseMsg"=>"Something Went wrong  try again !");
